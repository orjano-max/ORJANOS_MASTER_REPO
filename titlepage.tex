...
\newcommand{\projectTitle}{warehouse automation using autonomous differential drive robot and tag based pick and place}
\newcommand{\projectSubTitlel}{This thesis describes the use of an autonomous differential drive robot with a mounted robotic manipulator and camera to achieve warehouse automation.}
