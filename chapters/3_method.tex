...
The pick and place system consists of two main parts, machine vision, and the manipulator. Figure \ref{fig:M:PAP:PickAndPlaceMethod} illustrates how machine vision and the manipulator interact to create the pick and place system.
