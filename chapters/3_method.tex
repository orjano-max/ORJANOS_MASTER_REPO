...
\subsection{Machine Vision} \label{sec:M:PAP:MachineVision}
...
%aj line 6 - add 'described in Alg. 2' in comment
...
%aj - Algorithm 6 ? or alg. 3 check the name. I guess it should be Alg. 3
% aj -  line 7 : write 'explained in Alg. 4' in comments. similarly do for other lines and write assiciated algorithm
...
%aj line 6 goToSearchPos() ? write about it
